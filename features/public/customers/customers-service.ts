...
// Tipos auxiliares para criação/edição (DTOs)
...
export const createCustomerCategory = async (payload: CreateCategoryPayload): Promise<CustomerCategory> => {
  const { data } = await api.post('/customers/customer-categories', payload);
  return data;
};

export const updateCustomerCategory = async (id: string, payload: CreateCategoryPayload): Promise<CustomerCategory> => {
...
export const createAddressCategory = async (payload: CreateCategoryPayload): Promise<AddressCategory> => {
  const { data } = await api.post('/customers/address-categories', payload);
  return data;
};

export const updateAddressCategory = async (id: string, payload: CreateCategoryPayload): Promise<AddressCategory> => {
  // Backend usa @Put para categorias
