...
import { getStockProducts, createTransfer } from '../../api/stock.api';
          ...
          <Select
            ...
            nothingFoundMessage={
              searchQuery.trim().length === 0
                ? 'Digite o nome do produto que deseja transferir'
                : 'Nenhum produto encontrado com este nome.'
            }
          // renderOption={({ option }) => (
          //   <div
          //     style={{
          //       // Se estoque for 0, fica vermelho (ou cinza), senão cor normal
          //       color: option.disabled ? 'inherit' : '#4ff236ff',
          //       // Opcional: diminuir opacidade de itens sem estoque
          //       opacity: option.disabled ? 0.6 : 1
          //     }}
          //   >
          //     {option.label}

          //     {option.disabled && " (Sem Estoque)"}
          //   </div>
          // )}
          />
          <NumberInput
