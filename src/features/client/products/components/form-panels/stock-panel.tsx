...
import { ProductKardex } from '@/features/client/stock/components/product-kardex';
import { StockMovementModal } from '@/features/client/stock/components/modals/stock-movement-modal';
